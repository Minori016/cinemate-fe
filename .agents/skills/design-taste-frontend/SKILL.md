...
* **Max 3 lines** of quote body. Never 6. If the original quote is longer → cut it. A landing-page quote is a snippet, not the full review. For very small font sizes (e.g. footer-style testimonials), the line cap can stretch slightly. Spirit: "fits in a glance."
* **Typography:** Use real typographic quotes (`“ ”`) or none at all. Do not use generic quotes (`" "`) or mock em-dashes as design flourishes inside quote text.
