...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // BE trả về UserResponse với `roles` là Set<String> (vd: ["ADMIN", "MEMBER"])
  ...
  return (
    <>
      <Navbar />
    <main
      className="relative min-h-[calc(100vh-4rem)] w-full flex items-center justify-center p-6 overflow-hidden"
