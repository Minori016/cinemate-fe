  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-4xl text-white" style={{fontFamily:'Bebas Neue'}}>Quản lý phim</h1>
        <Button onClick={() => navigate('/admin/movies/add')}><Plus size={14} className="mr-1"/>Thêm phim</Button>
      </div>
